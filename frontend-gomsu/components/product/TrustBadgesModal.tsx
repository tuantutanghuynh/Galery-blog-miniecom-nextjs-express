...
const BADGES: Badge[] = [
  {
    ...
    fullDetail:
      'Nghĩa Phái bảo hiểm 100% rủi ro gãy vỡ trong quá trình vận chuyển toàn quốc. Khi nhận hàng, quý khách chỉ cần quay video khui hộp. Nếu sản phẩm bị sứt mẻ hoặc nứt vỡ, chúng tôi sẽ lập tức chế tác và gửi bản thay thế mới hoàn toàn miễn phí.',
  },
  {
    id: 'certificate',
    icon: '📜',
    ...
    fullDetail:
      'Mỗi tác phẩm đều được chế tác thủ công bởi các nghệ nhân Bát Tràng, nung ở nhiệt độ tiêu chuẩn 1300°C loại bỏ hoàn toàn độc tố kim loại nặng. Tác phẩm đi kèm giấy chứng nhận nguồn gốc và chất liệu độc bản.',
  },
  {
    id: 'packing',
    icon: '📦',
    ...
    fullDetail:
      'Sản phẩm gốm được bọc trong 5 lớp chống xóc chuyên dụng, đóng gói trong hộp quà bọc lót nhung tơ sang trọng, sẵn sàng để trao tặng hoặc trưng bày ngay khi mở hộp.',
  },
];
