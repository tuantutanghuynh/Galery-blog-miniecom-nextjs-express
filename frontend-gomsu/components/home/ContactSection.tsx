    ...
    <section className="py-20 lg:py-32 border-b border-gomsu-border bg-[#0a0a0a]">
      <div className="page-shell grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8">
        ...
        <div className="md:col-span-4 lg:col-span-3 flex flex-col gap-10">
          <div>
            <h4 className="font-sans text-xs uppercase tracking-[0.2em] text-gomsu-text-muted mb-4">
              Trụ sở
            </h4>
          ...
          <div>
            ...
            <div className="text-sm font-light leading-loose text-gray-300 flex flex-col">
              <a href="mailto:info@nghiaphai.vn" className="hover:text-gomsu-primary transition-colors">
                info@nghiaphai.vn
              </a>
              <a href="tel:+84123456789" className="hover:text-gomsu-primary transition-colors">
                +84 xxx xxx xxx
              </a>
            </div>
          </div>
        ...
        <div className="md:col-span-3 lg:col-span-3 flex flex-col gap-10">
          <div>
            ...
            <ul className="text-sm font-light leading-loose text-gray-300 flex flex-col">
              <li>
                <Link href="/art" className="hover:text-gomsu-primary transition-colors">
                  Nghệ thuật
                </Link>
              </li>
              <li>
                <Link href="/gallery" className="hover:text-gomsu-primary transition-colors">
                  Bộ sưu tập
                </Link>
              </li>
              <li>
                <Link href="/projects" className="hover:text-gomsu-primary transition-colors">
                  Dự án tiêu biểu
                </Link>
              </li>
              <li>
                <Link href="/blog" className="hover:text-gomsu-primary transition-colors">
                  Tin tức &amp; Sự kiện
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="text-sm font-light leading-loose text-gray-300 flex flex-col">
              <li>
                <a href="#" className="hover:text-gomsu-primary transition-colors">
                  Instagram
                </a>
              </li>
              <li>
